...
class DesS {
    private static class DES {
        ...
        int[] EP = { 32, 1, 2, 3, 4, 5, 4, 5, 6, 7, 8, 9, 8, 9, 10, 11, 12, 13, 12, 13, 14, 15, 16, 17, 16, 17, 18, 19,
    ...
    public static void main(String args[]) {
        try {
            ...
            System.out.print("Characters to be entered...(0-9)and(A-F)\n");
            Scanner sc = new Scanner(System.in);
            System.out.print("Enter the PlainText:(16 Character)\n");
            String text = sc.nextLine();
            text = text.toUpperCase();
            String plainText = "";
            for (int i = 0; i < text.length(); i++) {
                plainText += Integer.toHexString(text.charAt(i));
            }
            System.out.println("Plain Text : " + plainText);
            System.out.print("Enter the Key:(16 Character)\n");
            String key = sc.nextLine();
            DES cipher = new DES();
            System.out.println("ENCRYPTION : \n");
            text = cipher.encrypt(plainText, key);
